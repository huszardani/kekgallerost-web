-- Restrict partner-side status changes to the six states exposed in /partner.
-- Existing non-partner-managed statuses are preserved when p_status is null.
...
begin
  ...
  if p_status is not null and p_status not in (
    ...
    raise exception 'Invalid partner application status' using errcode = '22023';
  end if;
